...
$this->title = Yii::t('app', 'Вопросы по темам');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="flex-main-content">
    <h3><?= Html::encode($this->title) ?></h3>
    <p>
        <?= Html::button(Yii::t('app', 'Добавить вопрос по теме'), ['value'=>Url::to('/title-question/create'), 'title' => 'Добавить вопрос по теме', 'class' => 'btn btn-walive btn-success modalButton']) ?>
        <?= Html::a('Очистить фильтр', ['/title-question/clear-filter'], ['class' => 'btn btn-walive btn-danger']) ?>
    </p>
    <?php
    Modal::begin([
        ...
        'columns' => [
            [
                ...
                'filter' => Select2::widget([
                    ...
                    'data' => $titles,
                    'options' => [
                        'placeholder' => Yii::t('app', 'Тема вопросов ...'),
                        'multiple' => true,
                        'class' => 'label-warning'
                ...
                'contentOptions' => [
                    'style' => 'white-space: normal;width:48%;'
                ],
            ],
                            ...
                            'dropdown' => [
                                ...
                                'items' => [
                                    [
                                        'label' => 'Редактировать',
                                        'url' => '#',
                                        'linkOptions' => ['value'=> Url::to(['/title-question/update', 'id' => $model['id']]), 'title' => 'Редактирование вопроса по теме','class'=>'modalButton'],
                                    ],
                                    [
                                        'label' => 'Удалить',
                                        'url' => '/title-question/delete?id='.$model['id'],
                                        'linkOptions' => [
                                            'data' => [
                                                'confirm' => Yii::t('app', 'Вы действительно хотите удалить вопрос "{0}" по теме "{1}"?', [$model['question_short_name'], $model['title_short_name']]),
                                                'method' => 'post',
                                            ],
                                        ]
                                    ],
