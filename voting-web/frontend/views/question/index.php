...
<div class="flex-main-content">
    ...
    <p>
        <?= Html::button(Yii::t('app', 'Добавить вопрос'), ['value'=>Url::to('/question/create'), 'title' => 'Добавить вопрос', 'class' => 'btn btn-walive btn-success modalButton']) ?>
        <?= Html::a('Очистить фильтр', ['/question/clear-filter'], ['class' => 'btn btn-walive btn-danger']) ?>
    </p>
    <?php
    Modal::begin([
                            ...
                            'dropdown' => [
                                ...
                                'items' => [
                                    [
                                        'label' => 'Редактировать',
                                        'url' => '#',
                                        'linkOptions' => ['value'=> Url::to(['/question/update', 'id' => $model['id']]), 'title' => 'Редактирование вопроса','class'=>'modalButton'],
                                    ],
                                    [
                                        'label' => 'Удалить',
                                        ...
                                        'linkOptions' => [
                                            'data' => [
                                                'confirm' => Yii::t('app', 'Вы действительно хотите удалить вопрос: "{0}"?', $model['short_name']),
                                                'method' => 'post',
                                            ],
                                        ]
                                    ],
