...
$this->title = Yii::t('app', 'Темы вопросов');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="flex-main-content">
    <h3><?= Html::encode($this->title) ?></h3>
    <p>
        <?= Html::button(Yii::t('app', 'Добавить тему вопросов'), ['value'=>Url::to('/title/create'), 'title' => 'Добавить тему вопросов', 'class' => 'btn btn-walive btn-success modalButton']) ?>
        <?= Html::a('Очистить фильтр', ['/title/clear-filter'], ['class' => 'btn btn-walive btn-danger']) ?>
    </p>
    <?php
    Modal::begin([
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            [
                ...
                'contentOptions' => [
                    'style' => 'white-space: normal;width:35%;'
                ],
            ],
            [
                'format' => 'ntext',
                            ...
                            'dropdown' => [
                                ...
                                'items' => [
                                    [
                                        'label' => 'Редактировать',
                                        'url' => '#',
                                        'linkOptions' => ['value'=> Url::to(['/title/update', 'id' => $model['id']]), 'title' => 'Редактирование темы вопросов','class'=>'modalButton'],
                                    ],
                                    [
                                        'label' => 'Удалить',
                                        'url' => '/title/delete?id='.$model['id'],
                                        'linkOptions' => [
                                            'data' => [
                                                'confirm' => Yii::t('app', 'Вы действительно хотите удалить тему вопросов: "{0}"?', $model['short_name']),
                                                'method' => 'post',
                                            ],
                                        ]
                                    ],
