...
<div class="flex-main-content">
    ...
    <p>
        <?= Html::button(Yii::t('app', 'Добавить город'), ['value'=>Url::to('/city/create'), 'title' => 'Добавить город', 'class' => 'btn btn-walive btn-success modalButton']) ?>
        <?= Html::a('Очистить фильтр', ['/city/clear-filter'], ['class' => 'btn btn-walive btn-danger']) ?>
    </p>
    <?php
    Modal::begin([
                            ...
                            'dropdown' => [
                                ...
                                'items' => [
                                    [
                                        'label' => 'Редактировать',
                                        'url' => '#',
                                        'linkOptions' => ['value'=> Url::to(['/city/update', 'id' => $model['id']]), 'title' => 'Редактирование города ','class'=>'modalButton'],
                                    ],
                                    [
                                        'label' => 'Удалить',
                                        'url' => '/city/delete?id='.$model['id'],
                                        'linkOptions' => [
                                            'data' => [
                                                'confirm' => Yii::t('app', 'Вы действительно хотите удалить город: {0}?', $model['name']),
                                                'method' => 'post',
                                            ],
                                        ]
                                    ],
